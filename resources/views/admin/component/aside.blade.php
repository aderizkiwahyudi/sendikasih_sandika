        ...
        <ul>
            ...
            <li class="sub {{ Request::segment(2) =='halaman' ? 'active' : '' }}">
                ...
                <ul class="submenus">
                    ...
                    @else
                    <li class="{{ Request::segment(2) =='halaman' && Request::segment(3) =='sambutan-kepala-sekolah' ? 'active' : ''}}">
                        <a href="{{ route('admin.pages', 'sambutan-kepala-sekolah') }}">SAMBUTAN KEPALA SEKOLAH</a>
                    </li>
                    @endif
                </ul>
            </li>
            <li class="{{ Request::segment(2) =='gallery' ? 'active' : '' }}">
                <a href="{{ route('admin.gallery') }}"><i class="bi bi-images me-2"></i> {{ auth('admin')->user()->unit_id == 1 ? 'GALERI' : 'FASILITAS' }}</a>
            </li>
            ...
            @else
                <li class="{{  Request::segment(2) == 'kelas' && Request::segment(3) == 'mi' ? 'active' : '' }}">
                    <a href="{{ route('admin.class', unit(auth('admin')->user()->unit_id)) }}"><i class="bi bi-broadcast me-2"></i> DAFTAR KELAS</a>
                </li>
                <li class="{{ Request::segment(2) =='user' && Request::segment(3) =='siswa' ? 'active' : '' }}">
                    <a href="{{ route('admin.users.academic', ['siswa', unit(auth('admin')->user()->unit_id)]) }}"><i class="bi bi-people me-2"></i> DAFTAR SISWA</a>
                </li>
            @endif
            ...
            @if (auth('admin')->user()->unit_id == 1)
                ...
                <li class="{{ Request::segment(2) =='admin' ? 'active' : '' }}">
                    <a href="{{ route('admin.users.admin') }}"><i class="bi bi-people me-2"></i> ADMIN</a>
                </li>
