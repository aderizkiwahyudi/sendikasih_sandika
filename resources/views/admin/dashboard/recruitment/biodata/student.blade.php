<div class="main-form">
    ...
    <div class="form-group row align-items-center mb-4">
        ...
        <div class="col-md-4"><input type="text" name="father_name" id="father_name" value="{{ old('father_name', $user->father_job  ?? '') }}" placeholder="Masukan nama ayah " class="form-control" disabled></div>
