                        ...
                        <div class="modal fade text-dark" id="tambah-struktur" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <form method="post" action="{!! route('admin.structures.add') !!}">
                                        @csrf
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" class="form-control" name="name" placeholder="Masukan nama struktur" required/>
                                            </div>
                                        </div>
        ...
        <script>
            $(function() {
                $('#table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: '{!! route('admin.structures.data') !!}',
                    columns: [
