                        ...
                        <div class="modal fade text-dark" id="tambah-kategori" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <form method="post" action="{!! route('admin.pages.file.add', Request::segment(3)) !!}" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="number" class="form-control" name="year" placeholder="Masukan tahun" maxlength="5" required/>
                                            </div>
                                            <div class="form-group mb-3">
                                                <label class="text-dark mb-2">Keterangan</label>
                                                <textarea name="description" id="description" class="form-control w-100" maxlength="255"></textarea>
                                            </div>
                                            <div class="form-group mb-3">
                                                <label class="text-dark mb-2">File</label>
                                                <input type="file" class="form-control" name="file" placeholder="Masukan file" required/>
                                            </div>
                                        </div>
        ...
        <script>
            $(function() {
                $('#table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: '{!! route('admin.page.file.data', Request::segment(3)) !!}',
                    columns: [
