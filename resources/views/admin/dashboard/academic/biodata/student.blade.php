<form method="post" enctype="multipart/form-data">
    ...
    <div class="main-form">
        ...
        <div class="form-group row align-items-center mb-4">
            ...
            <div class="col-md-4"><input type="text" name="username" value="{{ old('name', $user->account->username ?? '') }}" id="username" placeholder="Masukan nama" class="form-control"></div>
        </div>
        <div class="form-group row align-items-center mb-4">
        ...
        <div class="form-group row align-items-center mb-4">
            ...
            <div class="col-md-4"><input type="password" name="password" id="password" placeholder="Masukan password" class="form-control"></div>
        </div>
        ...
        <div class="form-group row align-items-center mb-4">
            ...
            <div class="col-md-4"><input type="file" name="photo" id="photo" class="form-control"/></div>
        </div>
